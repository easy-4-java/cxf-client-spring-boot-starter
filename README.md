...
**Spring Boot Starter for cxf-client**
...
**cxf-client-spring-boot-starter** is a Spring Boot starter that integrates **cxf-client** for applications using cxf-client. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume cxf-client capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using cxf-client |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for cxf-client |
| JDK | `17` |
| Coordinates | `io.github.easy4j:cxf-client-spring-boot-starter:1.0.0-SNAPSHOT` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers cxf-client beans automatically |
