...
**Spring Boot Starter for spring-boot-starter-cxf-client**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/cxf-client-spring-boot-starter)](https://github.com/easy-4-java/cxf-client-spring-boot-starter)
...
> **Artifact ID**：`cxf-client-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**cxf-client-spring-boot-starter** is a Spring Boot starter that integrates **spring-boot-starter-cxf-client** for applications using spring-boot-starter-cxf-client. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume spring-boot-starter-cxf-client capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using spring-boot-starter-cxf-client |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for spring-boot-starter-cxf-client |
| JDK | `17` |
| Coordinates | `io.github.easy4j:cxf-client-spring-boot-starter:4.0.x.20260527-SNAPSHOT` |
| Config Prefix | `cxf.client` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers spring-boot-starter-cxf-client beans automatically |
| Property Binding | ✅ Stable | Binds `cxf.client.*` to `Properties` |
...
|---|---|---|:---:|---|:---:|
| `cxf.client.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl cxf-client-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `cxf.client.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/cxf-client-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/cxf-client-spring-boot-starter)
